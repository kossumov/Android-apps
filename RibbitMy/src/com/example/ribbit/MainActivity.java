		...
		public void onClick(DialogInterface dialog, int which) {
			switch(which){
				case 0: // take photo
					...
					if (mMediaUri == null) {
						Toast.makeText(MainActivity.this, "problem with accessing external storage", Toast.LENGTH_LONG).show();
					} else {
				...
				case 3: // choose video
					...
					Toast.makeText(MainActivity.this, "large video", Toast.LENGTH_LONG).show();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK){
			...
			if (requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST){
				if (data == null){
					Toast.makeText(this, "Sorryyy", Toast.LENGTH_LONG).show();
				} else {
				...
				if (requestCode == PICK_PHOTO_REQUEST){
					...
					fileSize = inputStream.available();
						...
						Toast.makeText(this, "Problem with selected file", Toast.LENGTH_LONG).show();
						return;
					} catch (IOException e) {
						Toast.makeText(this, "Problem with selected file", Toast.LENGTH_LONG).show();
						return;
						...
						try {
							inputStream.close();
						} catch (IOException e) { /* blank intentionally */  }
					}
